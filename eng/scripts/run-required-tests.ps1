...
$defaultMinimums = @{
    ...
    PluginAnalyzerHookChainTests = 61
    ...
    PluginServerSurpriseRegressionTests = 13
    ...
    ServerExtensionInlineScopedHandleTests = 5
    ServerExtensionReceiverAuthoritySurpriseTests = 3
    ...
    ServerExtensionLoweringSurpriseTests = 2
    ...
    ServerExtensionClientProxyValidationTests = 10
