...
$defaultMinimums = @{
    ...
    PluginAnalyzerHookChainTests = 58
    InvokeAsyncGenerationTests = 7
    InvokeAsyncSurpriseGenerationTests = 9
    InvokeAsyncGeneratedReceiverSurpriseTests = 13
    ...
    ServerExtensionReceiverAuthoritySurpriseTests = 2
    ...
    KernelRpcMarshallerSurpriseTests = 26
