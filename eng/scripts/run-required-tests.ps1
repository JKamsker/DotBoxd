...
$defaultMinimums = @{
    ...
    PluginServerMemberShapeRegressionTests = 5
    ...
    ServerExtensionSurpriseRegressionTests = 5
    ServerExtensionGeneratedDtoReaderRegressionTests = 2
    KernelRpcMarshallerSurpriseTests = 3
