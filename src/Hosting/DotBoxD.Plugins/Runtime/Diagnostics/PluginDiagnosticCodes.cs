...
public static class PluginDiagnosticCodes
{
    ...
    [
        ...
        new("DBXK033", PluginDiagnosticPhase.PreparedPackageValidation, PluginDiagnosticAudience.PluginAuthor,
            ...
            "ShouldHandle must return Bool, ordinary event Handle must return Unit, and both entrypoints need exact event-adapter and live-setting parameters.",
            "Match each entrypoint's return type and parameter shape to the hook event plus declared live settings; local callbacks may project a Handle value."),
