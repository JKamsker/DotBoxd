...
public static class PluginDiagnosticCodes
{
    ...
    [
        ...
        new("DBXK036", PluginDiagnosticPhase.RuntimeEntrypoint, PluginDiagnosticAudience.HostOperator,
            "An event value writer reports values that do not match the registered adapter parameters.",
            "The host-provided IPluginEventValueWriter<TEvent> returns a mismatched EventValueCount or a value with the wrong SandboxType.",
            "Make EventValueCount and each written SandboxValue match the adapter Parameters exactly."),
