...
internal static class ExtensionsGenerator
{
    public static string Generate(EquatableArray<ServiceIdentity> services, CancellationToken ct = default)
    {
        ...
        foreach (var service in services)
        {
            ...
            sb.AppendLine("        /// </summary>");
            sb.AppendLine($"        public static global::DotBoxd.Services.RpcPeer Provide{extensionSuffix}(this global::DotBoxd.Services.RpcPeer peer, {fullInterfaceName} implementation)");
            sb.AppendLine($"            => peer.Provide((global::DotBoxd.Services.Server.IServiceDispatcher)new {fullDispatcherName}(implementation));");

            sb.AppendLine();
            sb.AppendLine("        /// <summary>");
            sb.AppendLine($"        /// Gets a proxy to call {service.InterfaceName} on the other peer.");
            sb.AppendLine("        /// </summary>");
            sb.AppendLine($"        public static {fullInterfaceName} Get{extensionSuffix}(this global::DotBoxd.Services.RpcPeer peer)");
