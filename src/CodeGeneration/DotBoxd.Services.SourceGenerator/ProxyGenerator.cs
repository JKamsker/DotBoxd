...
internal static class ProxyGenerator
{
        ...
        CancellationToken ct = default)
    {
        ...
        sb.AppendLine("    {");
        sb.AppendLine("        private readonly global::DotBoxd.Services.IRpcInvoker _invoker;");
        ...
        sb.AppendLine();
        sb.AppendLine($"        public {proxyName}(global::DotBoxd.Services.IRpcInvoker client)");
        sb.AppendLine("        {");
        ...
        sb.AppendLine($"        public {proxyName}(global::DotBoxd.Services.IRpcInvoker client, string instanceId)");
        sb.AppendLine("        {");
        sb.AppendLine("            this._invoker = client ?? throw new global::System.ArgumentNullException(nameof(client));");
        ...
        CancellationToken ct)
    {
        ...
        {
            sb.AppendLine($"            throw new global::System.NotSupportedException(\"DotBoxd cannot marshal '{IdentifierHelpers.UnescapeIdentifier(method.Name)}': {LiteralHelpers.EscapeStringLiteral(method.UnsupportedReason)}\");");
        }
        else
        {
    ...
    private static string GetServiceHandleType(MethodModel method) =>
        method.SubService?.AllowsNull == true
            ? "global::DotBoxd.Services.Protocol.ServiceHandle?"
            : "global::DotBoxd.Services.Protocol.ServiceHandle";
