...
/// <summary>Diagnostic about one method (DBXS002) — emitted while still producing the rest of the service.</summary>
...
/// <summary>Diagnostic about the service as a whole (DBXS003) — service is skipped entirely.</summary>
