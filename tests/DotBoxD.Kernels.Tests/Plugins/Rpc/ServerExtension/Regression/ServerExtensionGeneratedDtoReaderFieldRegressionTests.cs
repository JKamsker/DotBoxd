...
{
    private const string MixedPropertyFieldDtoSource = """
        ...
        [ServerExtension(typeof(IRemoteWorldControl), "profile-field")]
    ...
    [Fact]
    public void Direct_extension_reconstructs_a_dto_with_public_properties_and_fields()
    {
