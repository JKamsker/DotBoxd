...
/// The in-code comment argued this was safe because DotBoxD runs context-free, but it only covers
/// SynchronizationContext deadlocks <em>of DotBoxD's own awaits</em>: a user disposer that suspends and
...
/// <c>ReleaseAllAsync</c> is internal, reachable here via <c>InternalsVisibleTo("DotBoxD.Services.Tests")</c>.
/// </para>
/// </summary>
