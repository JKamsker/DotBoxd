...
using static DotBoxD.Services.SourceGenerator.Tests.Behavior.BehavioralTestSupport;
...
public class BehavioralTests
{
    ...
    public void GeneratedExtensions_ExposeProvideAndGetPeerExtensionMethods()
    {
        ...
        getMethod!.GetParameters().Should().ContainSingle().Which.ParameterType.Should().Be(typeof(global::DotBoxD.Services.Peer.RpcPeer));
        ...
        provideMethod.GetParameters()[0].ParameterType.Should().Be(typeof(global::DotBoxD.Services.Peer.RpcPeer));
    }
