...
/// <summary>
/// Verifies that the DotBoxD incremental source generator caches downstream value-equal
...
public class IncrementalCacheTests
{
    ...
    public void RenamingServiceMethod_InvalidatesServiceButKeepsAggregateCachedAndRegeneratesSources()
    {
        ...
        var proxy = result.Results.Single().GeneratedSources
            .Single(g => g.HintName == "Demo_Svc_IFooService.DotBoxDRpcProxy.g.cs")
            .SourceText.ToString();
    ...
    public void AddingSecondService_KeepsFirstServiceOutputCachedAndInvalidatesAggregate()
    {
        ...
        hints.Should().Contain("Demo_Svc_IFooService.DotBoxDRpcProxy.g.cs");
        hints.Should().Contain("Demo_Svc2_IBarService.DotBoxDRpcProxy.g.cs");
